...
$my_email = "app@eastendlogistics.co.uk,pi.at@hotmail.it";
...
if(count($errors)){foreach($errors as $value){print "$value<br>";} echo '<a href="FormToEmail.php">Go back</a>'; exit;}
...
<p><b>Thank you <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?></b><p>
