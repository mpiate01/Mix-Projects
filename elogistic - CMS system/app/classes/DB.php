...
class DB 
{
	private static $_instance = null; 		//Singleton pattern variable
	private $_pdo, 
			$_query, 					//last query been executed
			$_error = false, 			//if query fails
			$_results, 					//result set
			$_affectedRowQuery = 0;		//counts result of query
